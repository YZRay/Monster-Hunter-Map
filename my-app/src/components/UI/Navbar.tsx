  ...
  return (
    <Fragment>
      <div className="container flex my-4 bg-slate-400 p-1 rounded-md gap-1 md:gap-4 top-0 z-30 shadow-lg bg-opacity-95">
        <Link
          href="/"
          className={`${pathname === '/' ? 'active' : ''} monster-tab flex items-center md:gap-2 text-lg`}
        >
        ...
        <Link
          href="/SelectionPage"
          className={`${pathname === '/SelectionPage' ? 'active' : ''} monster-tab flex items-center gap-2 text-lg`}
        >
