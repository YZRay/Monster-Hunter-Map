  ...
  return (
    <div className="w-full xl:w-max xl:flex gap-4">
      <Link
        ...
        } nav-btn px-4 py-3 mb-2 xl:mb-0 xl:py-1 transition-all duration-500 justify-center flex items-center md:gap-2 text-lg`}
      >
        <Image
      ...
      <Link
        ...
        } nav-btn px-4 py-3 mb-2 xl:mb-0 xl:py-1 transition-all duration-500 justify-center flex items-center gap-2 text-lg`}
      >
        <Image
          className="hidden xl:inline-block"
          src={MonsterIcon}
