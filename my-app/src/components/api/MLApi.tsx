...
export async function GetlocationList() {
  try {
    const response = await fetch(`${url}/api/monsterlocation/getlocationlist`);
    if (!response.ok) {
      throw new Error("Network response was not ok");
    }
    const data = await response.json();
...
export async function fetchMonsterLocation() {
  try {
    const response = await fetch(`${url}/api/monsterlocation/get`);
    if (!response.ok) {
      throw new Error("Network response was not ok");
    }
    const data = await response.json();
...
export async function createMonsterLocation(model: PostData) {
  const response = await fetch(`${url}/api/monsterlocation/create`, {
    method: "POST",
    headers: {
      accept: "text/plain",
...
export async function createBadLocation(model: ReportLocationModel) {
  const response = await fetch(`${url}/api/monsterlocation/createBadLocation`, {
    method: "POST",
    headers: {
      accept: "text/plain",
      "Content-Type": "application/json",
