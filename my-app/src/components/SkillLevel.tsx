...
const SkillLevel: FC<SkillLevelProps> = ({ skill }) => {
  ...
  return (
    <Fragment>
      <div className="max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-2xl xl:max-w-7xl mx-auto mt-4">
        <button
      ...
      {!isCollapsed && (
        <div className="max-w-xs sm:max-w-sm md:max-w-xl lg:max-w-2xl xl:max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 my-2 bg-gray-100 pb-2 pt-4 px-8 rounded-md shadow-md bg-opacity-90 gap-x-8 gap-y-4">
