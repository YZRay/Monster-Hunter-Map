...
const SelectionPage: FC = () => {
  ...
  return (
    <main className="flex gap-4 h-screen">
      <div
        className={`shadow-md fixed xl:relative overflow-y-auto h-screen col-span-auto flex flex-col gap-2 p-4 bg-slate-200 dark:bg-slate-800 top-0 transition-all duration-500 z-50 lg:left-0 ${
          isArmorOpen
